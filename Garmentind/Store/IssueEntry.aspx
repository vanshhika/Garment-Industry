<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="IssueEntry.aspx.cs" Inherits="Garmentind.Store.IssueEntry" %>
...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <br />
        <br />
        <h2>&nbsp; Material Issue Entry</h2>
        <div id="ie1">
           
            &nbsp;
           
            Issue No<asp:TextBox ID="TextBox1" runat="server"></asp:TextBox>
